...
توجه: تمامی تخصیص‌ها باید مدرک و فاکتور رسمی داشته باشد.`,
  ...
  },
  {
    id: "TAX-ART-011",
    slug: "moafiat-1405",
    title: "سقف معافیت مالیات حقوق ۱۴۰۵",
    category: "exemptions",
    content: `بر اساس قانون بودجه سال ۱۴۰۵، سقف معافیت مالیات حقوق ماهانه ۴۰ میلیون تومان (۴۰۰٬۰۰۰٬۰۰۰ ریال) و سالانه ۴۸۰ میلیون تومان (۴٬۸۰۰٬۰۰۰٬۰۰۰ ریال) است. درآمد تا این سقف کاملاً معاف است و مالیات فقط به مازاد بر آن تعلق می‌گیرد.`,
  ...
  },
  {
    id: "TAX-ART-012",
    slug: "jadval-1405",
    title: "جدول پلکانی مالیات حقوق ۱۴۰۵",
    category: "income-tax",
    content: `نرخ‌های ماهانه ۱۴۰۵ بر مازاد بر ۴۰ میلیون تومان: تا ۸۰ میلیون ۱۰٪، تا ۱۰۰ میلیون ۱۵٪، تا ۱۲۰ میلیون ۲۰٪، تا ۱۴۰ میلیون ۲۵٪، مازاد بر ۱۴۰ میلیون ۳۰٪. معادل سالانه: ۴۸۰ تا ۹۶۰ میلیون ۱۰٪، تا ۱٬۲۰۰ میلیون ۱۵٪، تا ۱٬۴۴۰ میلیون ۲۰٪، تا ۱٬۶۸۰ میلیون ۲۵٪، مازاد بر آن ۳۰٪. هر نرخ فقط بر همان پله اعمال می‌شود.`,
  ...
  {
    id: "TAX-ART-013",
    slug: "mashmul-moaf-1405",
    title: "موارد مشمول و معاف مالیات حقوق ۱۴۰۵",
    category: "exemptions",
    content: `مشمول: حقوق پایه، اضافه‌کاری، پاداش (به‌جز عیدی تا سقف)، حق مسکن، بن کارگری و مزایای رفاهی از ابتدای ۱۴۰۳. معاف: حقوق بازنشستگی و مستمری (ماده ۹۱)، سنوات و خسارت اخراج، عیدی تا سقف یک‌دوازدهم معافیت سالانه (۴۰ میلیون تومان)، هزینه واقعی مأموریت، مزایای غیرنقدی تا دو دوازدهم (۸۰ میلیون تومان)، حق اولاد، بازخرید مرخصی، حقوق نیروهای مسلح با معافیت خاص.`,
  ...
  {
    id: "TAX-ART-014",
    slug: "taklif-karfarma-1405",
    title: "تکلیف کارفرما و جرایم مالیات حقوق ۱۴۰۵",
    category: "procedures",
    content: `طبق ماده ۸۶، مالیات حقوق تکلیفی است: کارفرما محاسبه، کسر و پرداخت می‌کند. جرایم: عدم ارائه لیست در موعد ۲٪ حقوق پرداختی؛ عدم پرداخت به‌موقع ۱۰٪ مالیات پرداخت‌نشده؛ تأخیر ۲٫۵٪ مالیات به ازای هر ماه از سررسید.`,
  ...
  },
  {
    id: "TAX-ART-015",
    slug: "mesal-1405",
    title: "مثال محاسبه مالیات حقوق ۱۴۰۵",
    category: "income-tax",
    content: `حقوق ماهانه ۵۵ میلیون تومان: کسر معافیت ۴۰ میلیون = مازاد ۱۵ میلیون تومان در پله اول؛ مالیات = ۱۵٬۰۰۰٬۰۰۰ × ۱۰٪ = ۱٬۵۰۰٬۰۰۰ تومان در ماه. برای درآمدهای بالاتر، هر بخش از مازاد با نرخ پله خودش محاسبه و جمع می‌شود.`,
    sourceReference: "قانون بودجه سال ۱۴۰۵ — مثال کاربردی جدول پلکانی",
    effectiveFrom: "1404-01-01",
    effectiveTo: null,
    version: 1,
    status: "PUBLISHED",
